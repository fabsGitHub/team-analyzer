...
const de = {
  ...
  results: {
    ...
    onlyLeader: "Nur der Ersteller (Leader) einer Umfrage kann die Ergebnisse sehen.",
    location: "Die Ergebnisse findest du unter „Meine Umfragen“.",
    download: "Dort kannst du auch einen Download-Link (/api/surveys/[id]/results) erstellen, um die Ergebnisse als JSON herunterzuladen.",
    validity: "Der Link ist nur gültig, wenn er vorher von einem Leader erzeugt wurde.",
  },
  survey: {
    fill: {
      token: {
...
const en = {
  ...
  results: {
    ...
    download: "There you can also generate a download link (/api/surveys/[id]/results) to download the results as JSON.",
    validity: "The link is only valid if it was generated by a Leader beforehand.",
  },
  survey: {
    fill: {
      token: {
